			...
			<div class="user-menu" @click="toggleDropdown">
				...
				<div class="dropdown" :class="{ open: isDropdownOpen }">
					<div class="dropdown-menu">
						...
						<a href="#"
							><font-awesome-icon icon="user" class="dropdown-icon" /> <span>Profile</span></a
						>
						<a href="#"
							><font-awesome-icon icon="cog" class="dropdown-icon" /> <span>Settings</span></a
						>
						<a href="#"
...
import { faBars, faUser, faCog, faSignOutAlt, faCaretDown } from "@fortawesome/free-solid-svg-icons";
