...
# for print format
fixtures = [{"doctype": "Print format", "filters": ["name", "in", ["transaction"]]}]
...
fixtures = [
	{
		"doctype": "Workflow",
		"filters": [["name", "in", ["Session Workflow", "Evaluation Workflow", "Compensatory Lesson"]]],
	},
	{
		...
		"filters": [
			[
				...
				[
					...
					"Draft",
					"Pending Approval",
					"Approval Pending By Academic Manager",
					"Approval Pending By Department Head",
					"Approval Pending By Faculty Dean",
					"Cancelled",
				],
			]
		],
...
# Academic Calendar Procedure
fixtures = [{"dt": "Calendar Procedure"}]
